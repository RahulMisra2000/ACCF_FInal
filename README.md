## SNIPPETS
console.log('%cXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX','color:green');
...
firebase init		(1-time only)
		...
		Make sure you specify build as the folder and not public (i wasted a lot of time because of this error)
		Also add your domain to the authorized redirect in Firebase Console.
		Make sure emulator flags are set to false before building a production build and deploying to Firebase
			(In development turn them to true)

	firebase deploy --only hosting			// for only hosting
	firebase deploy							// will deploy everything
